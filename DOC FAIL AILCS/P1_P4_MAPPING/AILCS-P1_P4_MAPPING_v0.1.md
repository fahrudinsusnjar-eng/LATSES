# AILCS — PHASE 2 P1–P4 MAPPING v0.1

**Scope:** SRC-001 through SRC-008  
**Project boundary:** AILCS only  
**Phase status:** COMPLETE at source-level; cross-source consolidation pending

## P1–P4 definitions

- **P1 — Izvor/identitet:** original existence and provenance.
- **P2 — Zahtjev:** what the source actually states, without retrospective additions.
- **P3 — Usklađivanje:** placement in the AILCS structure and relationships; LAT/LATCES is excluded.
- **P4 — Verifikacija:** current evidence level and whether confirmation/modification/supersession/proposal remains to be established.

## Source coverage

| SOURCE-ID | Original source | Extracted OR records | P1 | P2 | P3 | P4 |
|---|---|---:|---|---|---|---|
...
This phase does **not** merge duplicates, resolve contradictions, promote technology examples to mandates, or create final canonical architecture. Those actions belong to the cross-source consolidation/status-action phase.
